...
import { readLessons, mergeLessonsFor, isValidStudent } from '../../../../lib/bakerhughes-progress-store';

// Sync de progresso por aluno (Baker Hughes). O aluno é SEMPRE derivado da
...
async function studentFromSession() {
  ...
  if (!canAccessClient(session, 'bakerhughes')) return null;
