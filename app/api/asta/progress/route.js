...
import { readLessons, mergeLessonsFor, isValidStudent } from '../../../../lib/asta-progress-store';

// Sync de progresso por aluno (ASTA). O aluno é SEMPRE derivado da
...
async function studentFromSession() {
  ...
  if (!canAccessClient(session, 'asta')) return null;
