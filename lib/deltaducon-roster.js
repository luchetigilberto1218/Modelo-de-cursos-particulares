...
export const TRACKS = [
  ...
  // Trilhas pessoais (índices 8 e 9), uma por aluno.
  'Projetos e Contratos (PMO)', 'Engenharia de Detalhamento',
];
...
export const ROSTER = [
  ...
  // Ago/26 — alunos novos, cada um na sua trilha pessoal.
  ['William Kulikowki', 8], ['Fernando Sumitani', 9],
];
